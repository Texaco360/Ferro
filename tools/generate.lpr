...
begin
  ...
  try
    ...
    L.Add('  fpjson;');
    L.Add('');
    L.Add('procedure Get' + MP + 's(');
    L.Add('  Req : THorseRequest;');
    L.Add('  Res : THorseResponse);');
    L.Add('');
    L.Add('procedure Get' + MP + 'ById(');
    L.Add('  Req : THorseRequest;');
    L.Add('  Res : THorseResponse);');
    L.Add('');
    L.Add('procedure Create' + MP + '(');
    L.Add('  Req : THorseRequest;');
    L.Add('  Res : THorseResponse);');
    L.Add('');
    L.Add('procedure Update' + MP + '(');
    L.Add('  Req : THorseRequest;');
    L.Add('  Res : THorseResponse);');
    L.Add('');
    ...
    L.Add('  Res : THorseResponse);');
    L.Add('var');
    L.Add('  Repo: T' + MP + 'Repository;');
    L.Add('  Items: TJSONArray;');
    L.Add('begin');
    L.Add('  Repo := T' + MP + 'Repository.Create;');
    L.Add('  Items := nil;');
    L.Add('  try');
    L.Add('    Items := Repo.GetAll;');
    L.Add('    Res');
    L.Add('      .ContentType(''application/json'')');
    L.Add('      .Send(Items.AsJSON);');
    L.Add('  finally');
    L.Add('    Items.Free;');
    L.Add('    Repo.Free;');
    L.Add('  end;');
    ...
    L.Add('  Repo := T' + MP + 'Repository.Create;');
    L.Add('  Item := nil;');
    L.Add('  ItemId := StrToIntDef(Req.Params[''id''], 0);');
    L.Add('  try');
    L.Add('    Item := Repo.GetById(ItemId);');
    L.Add('    Res');
    L.Add('      .ContentType(''application/json'')');
    L.Add('      .Send(Item.AsJSON);');
    L.Add('  finally');
    L.Add('    Item.Free;');
    L.Add('    Repo.Free;');
    L.Add('  end;');
    ...
    L.Add('  try');
    L.Add('    ItemId := Repo.Create' + MP + '(Item.Strings[''name'']);');
    ...
    L.Add('  ItemId := StrToIntDef(Req.Params[''id''], 0);');
    L.Add('  try');
    L.Add('    Repo.Update(ItemId, Item.Strings[''name'']);');
    L.Add('    Res');
    L.Add('      .ContentType(''application/json'')');
    L.Add('      .Send(Item.AsJSON);');
    L.Add('  finally');
    ...
    L.Add('  ItemId := StrToIntDef(Req.Params[''id''], 0);');
    L.Add('  try');
    L.Add('    Repo.Delete(ItemId);');
    L.Add('    Res.Status(204).Send('''');');
    L.Add('  finally');
    L.Add('    Repo.Free;');
    L.Add('  end;');
    L.Add('end;');
...
begin
  ...
  NewRoutes :=
    '  THorse.Get(''/api/' + ModelPlural + ''', Get' + ModelPascal + 's);' + LB +
    '  THorse.Get(''/api/' + ModelPlural + '/:id'', Get' + ModelPascal + 'ById);' + LB +
    '  THorse.Post(''/api/' + ModelPlural + ''', Create' + ModelPascal + ');' + LB +
    '  THorse.Put(''/api/' + ModelPlural + '/:id'', Update' + ModelPascal + ');' + LB +
    '  THorse.Delete(''/api/' + ModelPlural + '/:id'', Delete' + ModelPascal + ');' + LB +
    '  // $ROUTES_END';
