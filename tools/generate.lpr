...
begin
  ...
  try
    ...
    L.Add('');
    L.Add('type');
    L.Add('  T' + MP + 'Repository = class(TRepositoryBase)');
    L.Add('  private');
    L.Add('    function Map' + MP + '(const Query: TSQLQuery): TJSONObject;');
    L.Add('');
    L.Add('  public');
    L.Add('');
    ...
    L.Add('  SQLite3Conn;');
    L.Add('');
    L.Add('function T' + MP + 'Repository.Map' + MP + '(const Query: TSQLQuery): TJSONObject;');
    L.Add('begin');
    ...
    L.Add('      ''where id = :id'';');
    L.Add('');
    L.Add('    SetParamInt(Query, ''id'', AId);');
    L.Add('');
    L.Add('    Query.Open;');
    L.Add('');
    L.Add('    if not Query.EOF then');
    L.Add('      Result := Map' + MP + '(Query);');
    L.Add('');
    L.Add('  finally');
    L.Add('    Query.Free;');
    L.Add('    Conn.Free;');
    ...
    L.Add('');
    L.Add('  try');
    L.Add('    BeginTransaction(Conn);');
    L.Add('');
    L.Add('    Query.SQL.Text :=');
    L.Add('      ''insert into ' + MPl + ' (name) values (:name)'';');
    L.Add('');
    L.Add('    SetParamString(Query, ''name'', AName);');
    L.Add('');
    L.Add('    Query.ExecSQL;');
    L.Add('    CommitTransaction(Conn);');
    L.Add('');
    L.Add('    Query.SQL.Text :=');
    ...
    L.Add('');
    L.Add('  finally');
    L.Add('    if Conn.Transaction.Active then');
    L.Add('      RollbackTransaction(Conn);');
    L.Add('');
    L.Add('    Query.Free;');
    L.Add('    Conn.Free;');
    L.Add('  end;');
